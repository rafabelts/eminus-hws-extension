...
`,l.appendChild(c),d.insertBefore(m,d.firstChild),c.appendChild(d),n.appendChild(c)})})};var C=(r,e)=>{let t=document.createElement("p");t.style.fontSize="1.2 rem",t.style.color="red",e.remove(),r.appendChild(t)};var E=()=>{let r=document.querySelector(".d-flex.flex-column.align-items-center.mt-3");if(r){let e=document.createElement("div");e.classList.add("wrapper"),r.parentNode.insertBefore(e,r),e.appendChild(r);let t=document.createElement("div");t.classList.add("dues-container");let o=document.createElement("h1");o.textContent="Tareas pendientes:",o.style.fontSize="1.8rem",o.style.fontWeight="600";let i=document.createElement("div");i.classList.add("loader-div"),i.style.width="100%";let s=document.createElement("div");s.classList.add("loader"),t.appendChild(o),t.appendChild(i),i.appendChild(s),e.appendChild(t);let n=localStorage.getItem("accessToken");if(!n)C(i,s);else{w(n,t,i,s);let a=document.createElement("style");a.innerHTML=`
.wrapper {
display: flex;
flex-direction: row;
gap: 5px;
